...
ent-DeathRattleLavalandImplant = Останній Подих
    .desc = Цей імплант сповіщає локальний канал постачання та станційний медичний відділ, коли носій помирає або переходить у критичний стан. У разі смерті сигнал досягає станції й передає точні координати смерті.

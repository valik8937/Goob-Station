...
using Robust.Client.UserInterface; // Pirate
...
public sealed partial class GuidebookWindow : FancyWindow, ILinkClickHandler, IAnchorClickHandler // Pirate: add ILinkClickHandler
{
